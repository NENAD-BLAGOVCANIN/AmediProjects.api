...
class Collection extends Model
{
    ...
    protected $fillable = [
        'project_id', 'project_name', 'project_manager_mobile', 'accounting_manager_mobile', 'email', 'last_execution_date', 'agreed_payment_date',
        ...
        'is_archived' , 'have_problem', 'retention_5','last_invoice_issue_date', 'last_detail_sent_date','offset_instead_of_guarantee_before_vat','guarantee_end_date',
    ];
    ...
    {
        return $this->hasMany(MonthlyCollection::class, 'project_id', 'project_id');
    }
